...
Then('User click on filer and user search for auto and click Airhob', async () => {
    console.log('User click on filer and user search for auto and click Airhob');
    await page.getByPlaceholder('Filter').click();
    await page.getByPlaceholder('Filter').fill('air');
    await page.getByRole('link', { name: 'Airhobtest' }).click();
    //await page.waitForTimeout(3000);
});
...
Then('Verify Techdocs link is displayed', async ()=> {
    ...
    await page.waitForTimeout(5000);
    //await page.goto('http://a31ab0521b7614fc494b75314e386461-307954604.ap-southeast-1.elb.amazonaws.com:7007/catalog/default/component/TicketBookingAutomation');         
    await page.goto('http://a31ab0521b7614fc494b75314e386461-307954604.ap-southeast-1.elb.amazonaws.com:7007/catalog/default/component/Airhobtest');
...
Then('Verify Edit metadata link is displayed', async ()=> {
    ...
    const page2 = await page2Promise;
    await page2.goto('https://github.com/TheCognizantFoundry/TicketBooking/edit/Airhob/catalog-info.yaml');
    await page.waitForTimeout(3000);
    await page2.close();
});
